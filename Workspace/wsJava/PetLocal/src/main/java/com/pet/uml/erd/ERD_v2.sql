...
DROP TABLE ENTRPRS_INFO CASCADE CONSTRAINTS;
...
(
	...
	MBER_NO varchar2(9) NOT NULL,
	-- 기업번호
	ENTRPRS_NO varchar2(9) NOT NULL,
	-- 게시글제목
...
(
	...
	MBER_NO varchar2(9) NOT NULL,
	-- 기업구분
	ENTRPRS_SE varchar2(4) NOT NULL,
	-- 기업명
	ENTRPRS_NM varchar2(50) NOT NULL,
	-- 사업자 등록번호
	ENTRPRS_CONFIRM_NO varchar2(10) NOT NULL UNIQUE,
	-- 시작시간
	BEGIN_TIME varchar2(4) NOT NULL,
	-- 종료시간
	END_TIME varchar2(4) NOT NULL,
	-- 기업주소
	ENTRPRS_ADRES varchar2(200) NOT NULL,
	-- 연락처
	TEL varchar2(11) NOT NULL,
	-- Fax
	FAX varchar2(11),
...
ALTER TABLE BBS_INFO
	ADD FOREIGN KEY (ENTRPRS_NO)
	REFERENCES ENTRPRS_INFO (ENTRPRS_NO)
;
...
COMMENT ON COLUMN BBS_INFO.ENTRPRS_NO IS '기업번호';
...
COMMENT ON TABLE ENTRPRS_INFO IS '기업정보';
COMMENT ON COLUMN ENTRPRS_INFO.ENTRPRS_NO IS '기업번호';
COMMENT ON COLUMN ENTRPRS_INFO.MBER_NO IS '회원번호';
COMMENT ON COLUMN ENTRPRS_INFO.ENTRPRS_SE IS '기업구분';
COMMENT ON COLUMN ENTRPRS_INFO.ENTRPRS_NM IS '기업명';
COMMENT ON COLUMN ENTRPRS_INFO.ENTRPRS_CONFIRM_NO IS '사업자 등록번호';
COMMENT ON COLUMN ENTRPRS_INFO.BEGIN_TIME IS '시작시간';
COMMENT ON COLUMN ENTRPRS_INFO.END_TIME IS '종료시간';
COMMENT ON COLUMN ENTRPRS_INFO.ENTRPRS_ADRES IS '기업주소';
COMMENT ON COLUMN ENTRPRS_INFO.TEL IS '연락처';
COMMENT ON COLUMN ENTRPRS_INFO.FAX IS 'Fax';
COMMENT ON COLUMN ENTRPRS_INFO.EMAIL IS '이메일';
COMMENT ON COLUMN ENTRPRS_INFO.ENTRPRS_PHOTO IS '기업사진';
COMMENT ON COLUMN ENTRPRS_INFO.ENTRPRS_LINK IS '링크';
COMMENT ON COLUMN ENTRPRS_INFO.CLNIC_ANIMAL IS '진료동물';
COMMENT ON COLUMN ENTRPRS_INFO.ENTRPRS_INTRCN IS '기업소개';
COMMENT ON COLUMN ENTRPRS_INFO.isDelete IS '삭제여부';
